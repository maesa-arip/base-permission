        ...
        <div class="section-body">
            ...
            <div class="row mt-sm-4">
                ...
                <div class="col-12 col-md-12 col-lg-7">
                    <div class="card">
                        <form method="post" action="{{route('password.edit')}}" novalidate="">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="card-body">
                                <div class="row">
                                    <div class="form-group col-12">
                                        <label for="current_password" class="d-block">{{ __('Current Password') }}</label>
                                    ...
                                    <div class="form-group col-6">
                                        <label for="password2" class="d-block">{{ __('Konfirmasi Password') }}</label>

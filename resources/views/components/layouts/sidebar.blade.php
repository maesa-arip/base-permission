            ...
            <ul class="sidebar-menu">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a class="nav-link" href="{{route('registration.index')}}">Registrasi</a></li>
                    </ul>
                </li> -->
                @foreach($navigations as $navigation)
                @can($navigation->permission_name)
                <li class="menu-header">{{$navigation->name}}</li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>{{$navigation->name}}</span></a>
                    <ul class="dropdown-menu">
                ...
                <!-- @can('create naviagtion')
                <li class="menu-header">Navigation Setup</li>
                <li class="nav-item dropdown">
                    <a href="#" class="nav-link has-dropdown" data-toggle="dropdown"><i class="fas fa-columns"></i> <span>Navigation Setup</span></a>
                    <ul class="dropdown-menu">
                        <li><a class="nav-link" href="{{route('navigation.create')}}">Create Navigation</a></li>
                        <li><a class="nav-link" href="{{route('navigation.table')}}">Data Table</a></li>
                    </ul>
                </li>
                @endcan -->

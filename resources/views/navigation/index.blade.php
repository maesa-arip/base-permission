    ...
    <section class="section">
        <div class="section-header">
            ...
            <div class="section-header-button">
                <a href="{{route('navigation.create')}}" class="btn btn-primary">Tambah @yield('title')</a>
            </div>

...
<div class="row">
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="name" id="name" value="{{old('name') ?? $navigation->name}}" class="form-control" placeholder="Create new Posts">
            @error('name')
            <div class="text-danger" mt-2 d-block>{{$message}}</div>
            @enderror
        </div>
    ...
    <div class="col-md-6">
        <div class="form-group">
            ...
            <input type="text" name="url" id="url" value="{{old('url') ?? $navigation->url}}" class="form-control" placeholder="posts/create">
        </div>
    </div>
</div>
